...
void* calculator(void* p) {
    system("gnome-terminal --disable-factory -- ./calculator");
    return NULL;
}

void* clock(void* p) {
    system("gnome-terminal --disable-factory -- ./clock"); 
    return NULL;
}

void* copyFile(void* p) {
    system("gnome-terminal --disable-factory -- ./copyFile"); 
    return NULL;
}


void* deletefile(void* p) {
    system("gnome-terminal --disable-factory -- ./deleteFile"); 
    return NULL;
}

void* Fileproperties(void* p) {
    system("gnome-terminal --disable-factory -- ./Fileproperties"); 
    return NULL;
}

void* moveFile(void* p) {
    system("gnome-terminal --disable-factory -- ./moveFile"); 
    return NULL;
}

void* notepad(void* p) {
    system("gnome-terminal --disable-factory -- ./notepad"); 
    return NULL;
}

void* cutFile(void* p) {
    system("gnome-terminal --disable-factory -- ./cutFile"); 
}

void* song(void* p) {
    system("gnome-terminal --disable-factory -- ./song"); 
}

//what is gnome terminal?
//gnome terminal is a terminal emulator for GNOME desktop environment
//what is --disable-factory?
//it is a command used to disable the factory
//why we disable the factory?
//to avoid the error of "Error constructing proxy for org.gnome.Terminal:/org/gnome/Terminal/Factory0: Error calling StartServiceByName for org.gnome.Terminal: Timeout was reached"
...
void listProcesses() {
    ...
    //what is ps -A?
    //ps -A is a command used to list all the processes running on the system
    //what is awk?
    //awk is a command used to manipulate text files
...
void terminateProcess(int pid) {
    ...
    //what is kill -9?
    //kill -9 is a command used to kill a process by its PID
...
void display_res() {
    ...
    //proc directory is a directory in linux that contains information about the processes running on the system
